...
import numpy as np
from tsar import get_supervised_features, get_unsupervised_features, print_graph_for_instance, get_NN_for_dataset, preprocess_raw_data_and_labels, add_noise_to_labels
...
if __name__ == "__main__":
    ...
    for s in ["adl", "two_classes"]:
        ...
        for i in range(3):
            ...
            while instance in bad:
                instance = rand.randint(0, len(X))
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_trad_correct_"+str(i)+".png", False)

        print("Mislabeled")
        for i in range(3):
            instance = rand.choice(bad)
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_trad_mislabeled_"+str(i)+".png", True)
        ...
        for i in range(3):
            ...
            while instance in bad:
                instance = rand.randint(0, len(X))
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_sup_correct_"+str(i)+".png", False)

        print("Mislabeled")
        for i in range(3):
            instance = rand.choice(bad)
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_sup_mislabeled_"+str(i)+".png", True)
        ...
        for i in range(3):
            ...
            while instance in bad:
                instance = rand.randint(0, len(X))
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_unsup_correct_"+str(i)+".png", False)

        print("Mislabeled")
        for i in range(3):
            instance = rand.choice(bad)
            print(i+1,": point ", instance)
            print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_unimib_"+s+"_unsup_mislabeled_"+str(i)+".png", True)
    ...
    for i in range(3):
        ...
        while instance in bad:
            instance = rand.randint(0, len(X))
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_trad_correct_"+str(i)+".png", False)

    print("Mislabeled")
    for i in range(3):
        instance = rand.choice(bad)
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_trad_mislabeled_"+str(i)+".png", True)
    ...
    for i in range(3):
        instance = rand.randint(0, len(X))
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_sup_correct_"+str(i)+".png", False)

    print("Mislabeled")
    for i in range(3):
        instance = rand.randint(0, len(X))
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_sup_mislabeled_"+str(i)+".png", True)
    ...
    for i in range(3):
        instance = rand.randint(0, len(X))
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_unsup_correct_"+str(i)+".png", False)

    print("Mislabeled")
    for i in range(3):
        instance = rand.randint(0, len(X))
        print(i+1,": point ", instance)
        print_graph_for_instance(X, y, labels, instance, feat, neighbors, vis, False, True, "imgs/noisy_uci_unsup_mislabeled_"+str(i)+".png", True)
